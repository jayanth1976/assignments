...
public class Main {
    public static void main(String[] args) {
        ...
        studentDetails.getAllDepartments(studentList);
        studentDetails.getNamesEnrolledAfter2018(studentList);
        studentDetails.getNamesOfAllMenInCseDept(studentList);
        studentDetails.getGenderCount(studentList);
        studentDetails.getAvgAgeOfMenAndWomen(studentList);
        studentDetails.studentWithHighestPercentage(studentList);
        studentDetails.countNoStudents(studentList);
        studentDetails.averagePercentageInDepartments(studentList);
        studentDetails.youngestMale(studentList);
        studentDetails.menAndWomenInCse(studentList);
    }
}
